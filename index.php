...
<head>
  ...
  <title>Minimarket Alina | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php">Minimarket Alina</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <!--<p class="login-box-msg">Inicio de sesión</p>-->
	<div class="text-center">
					<img width="175" height="93"  src="./img/acceso.png">
					<h5 class="content-group">Bienvenido a PosNet<small class="display-block"><br/>Iniciar Sesión</small></h5>
				</div>
    ...
    <form action="" method="post" autocomplete="off">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
            <button type="submit" class="text-muted text-center btn-block btn btn-primary btn-rect" name="btn_login">Ingresar al Sistema</button>
