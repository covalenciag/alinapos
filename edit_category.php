<?php
  ...
  if(isset($_POST['btn_edit'])){
	  ...
	  $id = $_POST['id'];
      /*$update = $pdo->prepare("UPDATE tbl_category SET cat_name='$category_name' WHERE cat_id='".$_POST['id']."' ");
      $update->bindParam(':cat_name', $category_name);*/
	  
	   $update = $pdo->prepare("UPDATE tbl_category SET cat_name=:cat_name WHERE cat_id=$id");
