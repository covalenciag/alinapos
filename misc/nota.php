...
$pdf->Cell(60,10,'Minimarket Alina',0,1,'C');

$pdf->Line(10,18,72,18);
$pdf->Line(10,19,72,19);

$pdf->SetFont('Arial','',8);
$pdf->Cell(60,3,'Direccion: Afilador s/n Tingo Maria',0,1,'C');
...
while($item = $select->fetch(PDO::FETCH_OBJ)){
    ...
    $pdf->Cell(18,5,'S/. '.number_format($item->price,2),1,0,'R');
    $pdf->Cell(18,5,'S/. '.number_format($item->total,2),1,1,'R');
}
...
$pdf->Cell(1,8 ,'S/. ' . number_format($row->total,2),0,1,'C');
...
$pdf->SetFont('Arial','BI',7);
$pdf->Cell(1,4 ,'S/. '. number_format($row->paid,2),0,1,'C');
...
$pdf->SetFont('Arial','BI',7);
$pdf->Cell(1,8 ,'S/. '. number_format($row->due,2),0,1,'C');
