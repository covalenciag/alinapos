        ...
        <div class="box box-success">
          <form action="" method="POST">
            ...
            <div class="box-body">
              <div class="col-md-offset-1 col-md-10">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      <span>S/. <?php echo $_SESSION['invoice_id']; ?></span>
                    </div>
            ...
            <div class="box-footer" align="center">
              <input type="submit" name="save_order" value="Guardar venta" class="btn btn-success">
              <a href="order.php" class="btn btn-warning">Volver</a>
            </div>
          </form>
        </div>
    </section>
