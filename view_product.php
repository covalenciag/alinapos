              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Precio de capital</b>  :<span class="label label-warning pull-right">S/. <?php echo number_format($row->purchase_price,2); ?></span></li>
                    <li class="list-group-item"><b>Precio de venta</b>     :<span class="label label-warning pull-right">S/. <?php echo number_format($row->sell_price,2); ?></span></li>
                    <li class="list-group-item"><b>Ganancia</b>           :<span class="label label-success pull-right">S/. <?php echo number_format(($row->sell_price - $row->purchase_price),2); ?></span></li>
